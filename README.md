...
## About me: 
**Backend**-разработчик с опытом создания скриптов для автоматизации задач, работы с данными,
авторизации пользователей, проектирования БД и парсинга информации. 
Интересуюсь **backend**-разработкой, API-интеграциями и анализом данных.
